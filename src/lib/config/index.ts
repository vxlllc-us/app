...
const services: IService[] = [
   ...
   },
   {
     icon: faDatabase,
      ...
      description:"VLX experts have helped several customers and governments in Big Data and analytics. Our experts have experience in Apache-Storm, Apache-Spark, Apache-Flink, Hadoop etc."
   },
];
